...
def compact_summary(checkpoint: int, summary: dict[str, Any], score: float) -> dict[str, Any]:
    keys = [
        ...
        "omni_car/reward/clearance_target_opening",
        "omni_car/reward/blocked_lateral_escape",
        ...
        "scenarios": [
            {
                ...
                "action_vx_mean": item.get("action_vx_mean"),
                "action_vy_mean": item.get("action_vy_mean"),
                "action_vyaw_mean": item.get("action_vyaw_mean"),
                "yaw_abs_mean": item.get("yaw_abs_mean"),
                "yaw_projection_mean": item.get("yaw_projection_mean"),
                "projection_mean": item.get("projection_mean"),
                "projection_ratio_mean": item.get("projection_ratio_mean"),
                ...
                "reward_clearance_target_opening_mean": item.get(
                    "reward_clearance_target_opening_mean"
                ),
                "reward_blocked_lateral_escape_mean": item.get(
                    "reward_blocked_lateral_escape_mean"
                ),
                "reward_target_collision_mean": item.get("reward_target_collision_mean"),
                "reward_blocked_projection_mean": item.get(
                    "reward_blocked_projection_mean"
                ),
                "reward_blocked_speed_mean": item.get("reward_blocked_speed_mean"),
                "reward_blocked_stop_mean": item.get("reward_blocked_stop_mean"),
